...
| .NET Wrapper | `dotnet.md` | `https://github.com/aws/aws-advanced-dotnet-data-provider-wrapper/releases/latest` | 1.2.0 |
| Go Wrapper | `go.md` | `https://github.com/aws/aws-advanced-go-wrapper/releases/latest` | 2026-05-26 |
| ODBC PostgreSQL Wrapper | `odbc.md` | `https://github.com/aws/aws-advanced-odbc-wrapper/releases/latest` | 1.1.0 |
