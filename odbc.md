...
**Latest Version:** [1.2.0](https://github.com/aws/aws-advanced-odbc-wrapper/releases/tag/1.2.0)  
...
wget https://github.com/aws/aws-advanced-odbc-wrapper/releases/download/1.2.0/aws-advanced-odbc-wrapper-1.2.0-macos-arm64.zip
unzip aws-advanced-odbc-wrapper-1.2.0-macos-arm64.zip
...
```bash
# Download and extract
wget https://github.com/aws/aws-advanced-odbc-wrapper/releases/download/1.2.0/aws-advanced-odbc-wrapper-1.2.0-linux-x64.tar.gz
tar -xzf aws-advanced-odbc-wrapper-1.2.0-linux-x64.tar.gz
